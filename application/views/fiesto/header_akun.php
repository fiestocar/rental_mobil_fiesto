      ...
      <div class="align-self-end">
        ...
        <div class="btn tombol-akun dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="<?php echo base_url('fiesto'); ?>">Akunku</a>
            <a href="<?php echo base_url('fiesto/garasi'); ?>">Garasiku</a>
            <a href="<?php echo base_url('fiesto/pengaturan'); ?>">Pengaturan</a>
            <a href="<?php echo base_url('fiesto/keluar'); ?>">Keluar</a>
          </div>
        </div>
